...
const WomenCell = ({ language, onBack }) => {
    const content = {
        en: {
            title: 'Women Cell',
    ...
    return (_jsxs("div", { className: "women-cell-page", children: [_jsxs("div", { className: "women-cell-header", children: [_jsx("button", { className: "back-button", onClick: onBack, children: "\u2190 Back" }), _jsx("h1", { children: data.title }), _jsx("p", { className: "women-cell-subtitle", children: data.subtitle })] }), _jsxs("div", { className: "women-cell-container", children: [_jsx("div", { className: "women-cell-description", children: _jsx("p", { children: data.description }) }), _jsx("div", { className: "women-cell-sections-section", children: _jsx("div", { className: "women-cell-sections-grid", children: data.sections.map((section, index) => (_jsxs("div", { className: "women-cell-section-card", children: [_jsx("div", { className: "women-cell-section-icon", children: section.icon }), _jsx("h3", { children: section.title }), _jsx("p", { children: section.description })] }, index))) }) }), _jsx("div", { className: "women-cell-cta-section", children: _jsx("button", { className: "women-cell-submit-btn", children: data.cta }) })] })] }));
};
export default WomenCell;
//# sourceMappingURL=WomenCell.js.map