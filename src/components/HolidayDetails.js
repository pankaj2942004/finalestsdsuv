...
const HolidayDetails = ({ language }) => {
    ...
    return (_jsx("section", { className: "holiday-details", children: _jsxs("div", { className: "section-container", children: [_jsx("h1", { children: data.title }), _jsx("p", { className: "section-subtitle", children: data.subtitle }), _jsx("div", { className: "holiday-grid", children: data.holidays.map((holiday, index) => (_jsxs("div", { className: "holiday-card", children: [_jsx("div", { className: "holiday-icon", children: holiday.icon }), _jsx("div", { className: "holiday-date", children: holiday.date }), _jsx("h3", { children: holiday.name }), _jsx("span", { className: "holiday-type", children: holiday.type })] }, index))) })] }) }));
};
export default HolidayDetails;
//# sourceMappingURL=HolidayDetails.js.map