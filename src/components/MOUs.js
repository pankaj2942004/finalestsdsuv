...
const MOUs = ({ language, onBack }) => {
    ...
    return (_jsxs("div", { className: "moues-page-new", children: [_jsxs("div", { className: "moues-header-new", children: [_jsxs("button", { className: "back-button-new", onClick: onBack, children: ["\u2190 ", language === 'en' ? 'Back' : 'पीछे'] }), _jsx("h1", { className: "moues-title-new", children: data.title })] }), _jsx("div", { className: "moues-content-wrapper-new", children: _jsxs("div", { className: "moues-box-new", children: [_jsx("h2", { className: "moues-main-heading-new", children: data.mainHeading }), _jsx("p", { className: "moues-description-new", children: data.description }), _jsx("ul", { className: "moues-list-new", children: data.mous.map((item, index) => (_jsx("li", { children: item }, index))) })] }) })] }));
};
export default MOUs;
//# sourceMappingURL=MOUs.js.map