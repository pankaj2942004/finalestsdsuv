...
const AdmissionNews = ({ language }) => {
    ...
    return (_jsxs("section", { className: "admission-news", children: [_jsx("div", { className: "news-header", children: _jsx("div", { className: "section-container", children: _jsxs("div", { className: "news-header-content", children: [_jsx("div", { className: "news-icon-square", children: "\u25A0" }), _jsxs("div", { className: "news-title-group", children: [_jsx("h1", { children: data.latestUpdates }), _jsx("p", { children: data.newsDescription })] })] }) }) }), _jsx("div", { className: "news-container", children: _jsx("div", { className: "section-container", children: _jsx("div", { className: "news-scroll-wrapper", children: data.newsItems.map((item, index) => (_jsxs("div", { className: "news-card", children: [_jsxs("div", { className: "news-header-info", children: [_jsx("span", { className: "news-date", children: item.date }), _jsx("span", { className: "news-tag", children: item.tag })] }), _jsx("h3", { children: item.title }), _jsx("p", { children: item.description })] }, index))) }) }) })] }));
};
export default AdmissionNews;
//# sourceMappingURL=AdmissionNews.js.map