...
const StudentFeedbackForm = ({ language, onBack }) => {
    const content = {
        en: {
    ...
    return (_jsxs("div", { className: "student-feedback-form-page", children: [_jsxs("div", { className: "student-feedback-form-header", children: [_jsx("button", { className: "back-button", onClick: onBack, children: "\u2190 Back" }), _jsx("h1", { children: data.title }), _jsx("p", { className: "student-feedback-form-subtitle", children: data.subtitle })] }), _jsxs("div", { className: "student-feedback-form-container", children: [_jsx("div", { className: "student-feedback-form-description", children: _jsx("p", { children: data.description }) }), _jsx("div", { className: "student-feedback-form-sections-section", children: _jsx("div", { className: "student-feedback-form-sections-grid", children: data.sections.map((section, index) => (_jsxs("div", { className: "student-feedback-form-section-card", children: [_jsx("div", { className: "student-feedback-form-section-icon", children: section.icon }), _jsx("h3", { children: section.title }), _jsx("p", { children: section.description })] }, index))) }) }), _jsx("div", { className: "student-feedback-form-cta-section", children: _jsx("button", { className: "student-feedback-form-submit-btn", children: data.cta }) })] })] }));
};
export default StudentFeedbackForm;
//# sourceMappingURL=StudentFeedbackForm.js.map