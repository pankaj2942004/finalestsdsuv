...
const NCC = ({ language, onBack }) => {
    ...
    return (_jsxs("div", { className: "ncc-page", children: [_jsxs("div", { className: "ncc-header", children: [_jsx("button", { className: "back-button", onClick: onBack, children: "\u2190 Back" }), _jsx("h1", { children: data.title }), _jsx("p", { className: "ncc-subtitle", children: data.subtitle })] }), _jsxs("div", { className: "ncc-container", children: [_jsx("div", { className: "ncc-description", children: _jsx("p", { children: data.description }) }), _jsxs("div", { className: "ncc-section", children: [_jsx("h2", { children: "NCC Wings & Programs" }), _jsx("div", { className: "ncc-grid", children: data.categories.map((category, index) => (_jsxs("div", { className: "ncc-card", children: [_jsx("div", { className: "ncc-icon", children: category.icon }), _jsx("h3", { children: category.name }), _jsx("p", { className: "count", children: category.count }), _jsx("p", { className: "description", children: category.description }), _jsx("button", { className: "join-btn", children: "Learn More" })] }, index))) })] })] })] }));
};
export default NCC;
