...
const Header = ({ language, setCurrentPage }) => {
    ...
    return (_jsxs("header", { className: "header", children: [_jsxs("div", { className: "header-top", children: [_jsxs("div", { className: "logo-section", children: [_jsx("div", { className: "logo-placeholder", children: _jsx("img", { src: "/img/logo.jpg", alt: "Sri Dev Suman Uttarakhand University Logo", className: "logo-image" }) }), _jsx("h1", { children: data.university })] }), _jsx("div", { className: "header-portrait-section", children: _jsx(AdmissionPortrait, { language: language }) })] }), _jsx("nav", { className: "navbar", children: data.nav.map((item, index) => {
                    ...
                    return (_jsx("div", { className: "nav-item", onMouseEnter: menuItems ? (e) => handleMouseEnter(index, e) : undefined, onMouseLeave: menuItems ? handleMouseLeave : undefined, children: menuItems ? (_jsxs(_Fragment, { children: [_jsxs("button", { className: "nav-link dropdown-toggle", onClick: (e) => handleDropdownToggle(index, e), children: [item, _jsx("span", { className: "dropdown-arrow", children: "\u25BC" })] }), openDropdown === index && (_jsx("div", { className: `dropdown-menu ${menuClass}`, children: menuItems.map((subitem, subindex) => (_jsx("a", { href: subitem.url, className: "dropdown-item", onClick: (e) => {
                                            e.preventDefault();
                                            handleDropdownItemClick(subitem.labelEn, subitem.labelHi);
                                        }, children: language === 'en' ? subitem.labelEn : subitem.labelHi }, subindex))) }))] })) : item === 'Administration' || item === 'प्रशासन' ? (_jsx("button", { className: "nav-link", onClick: () => setCurrentPage?.('administration'), children: item })) : item === 'About Us' || item === 'हमारे बारे में' ? (_jsx("button", { className: "nav-link", onClick: () => setCurrentPage?.('about'), children: item })) : (_jsx("a", { href: "#", className: "nav-link", children: item })) }, index));
                }) })] }));
};
