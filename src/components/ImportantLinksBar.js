...
const ImportantLinksBar = ({ language, onLinkClick }) => {
    const links = [
        {
    ...
    return (_jsx("div", { className: "important-links-bar", children: _jsx("div", { className: "important-links-container", children: links.map((link) => (_jsx("a", { href: link.url, className: "important-link-btn", title: language === 'en' ? link.textEn : link.textHi, onClick: (e) => handleClick(e, link.id), children: language === 'en' ? link.textEn : link.textHi }, link.id))) }) }));
};
export default ImportantLinksBar;
//# sourceMappingURL=ImportantLinksBar.js.map